...
public class mechanicViewClients extends AppCompatActivity {
    ...
    private void populateSearch(DataSnapshot snapshot){
        ...
        else
        {
            ...
            Toast.makeText(mechanicViewClients.this, "Nu au fost identificate date!", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                else
                {
                    ...
                    Toast.makeText(mechanicViewClients.this, "Nu au fost identificate detalii!", Toast.LENGTH_SHORT).show();
                }
            }
